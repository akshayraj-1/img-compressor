...
function ImageComparison({ beforeImage, afterImage, className }) {
    ...
    return (
        <div
            className={cn("relative overflow-hidden w-full aspect-[21/12] text-colorSurface text-[0.75rem]", className)}>

            <div className="absolute z-[1] size-full overflow-hidden" style={{clipPath: `inset(0 ${100 - currentWidth}% 0 0)`}}>
                <img className="size-full object-cover object-left" src={beforeImage.src} alt="Before Image" loading={"lazy"}/>
            ...
            <div className="absolute size-full overflow-hidden">
                <img className="size-full object-cover object-left" src={afterImage.src} alt="After Image" loading={"lazy"}/>
            ...
            >
                <span className="flex-1 w-[2px] bg-colorSurface/80"></span>
                <SeparatorVertical
                    className="relative z-[1] rounded-full bg-black/50 border-2 border-colorSurface p-2"
