...
function useCustomToast() {
    ...
    const styles = {
        ...
        body: cn("relative flex gap-2 items-center bg-colorSurface w-full sm:w-fit px-5 py-3 rounded-md shadow-md", toastType === "error" ? "bg-red-500" : "bg-green-500"),
        message: cn("sm:text-[0.8rem] text-sm", toastType === "error" || toastType === "success" ? "text-white" : "text-colorPrimary"),
    };
